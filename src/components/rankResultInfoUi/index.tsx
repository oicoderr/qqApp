...
export default class RankResultInfo extends Component{
        ...
        this.state = {
            ...
            data: {
                rankResultInfo:{
                    ...
                    haveStar: 1,
                    totalStar: 4,
                    gloryUrl: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/glory.png' // 段位的icon
                }
            },
            
            // 默认组件数据
            local_data:{
                successUrl: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/victoryTitle.png',
                failUrl: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/failTitle.png',
                drawUrl: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/drawTitle.png',
                bgImg: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/rankBg.png',
                confirmBtnUrl: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/rankResultSureBtn.png',
                // 镂空星
    ...
    render() {
        ...
        const { rankResultUrl, bgImg, blankStar, shineStar, confirmBtnUrl, seeAdsStatus, adsTip, checked } = this.state.local_data;
