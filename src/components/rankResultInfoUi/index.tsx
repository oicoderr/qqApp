...
export default class RankResultInfo extends Component {
  ...
  render() {
    const { result, dan, danDesc, haveStar, totalStar, gloryUrl, segmentTitleUrl, } = this.state.data.rankResultInfo;
    const {
      rankResultUrl,
      bgImg,
      blankStar,
          ...
          <View className="content">
            ...
            <View className="body">
              ...
              <View className='segmentTitleUrlBox'>
                <Image src={segmentTitleUrl} className='segmentTitleUrl' />
              </View>
              {/*   超过第8段位，星星展示 x50 */}
