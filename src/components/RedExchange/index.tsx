...
export default class RedExchange extends Component{
    constructor(props) {
        ...
        this.state = {
            local_data: {
                ...
                maxLength: 5,
                curValue: 1, // 提交给后台的数量
                addIcon: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/addIcon.png',
                removeIcon: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/removeIcon.png',
    ...
    render() {
        const { closeImgBtn, cancelBtnText, confirmBtnText, title, tip, curValue, addIcon, minLength, maxLength, confirmType, removeIcon } = this.state.local_data;
                            ...
                            <View className='countWrap'>
                                ...
                                <View className='inputBoard'>
                                    <Input type='number' onChange={this.onChange.bind(this)} 
                                        placeholder={curValue} maxLength={maxLength} 
                                        minLength={minLength} value={curValue}
