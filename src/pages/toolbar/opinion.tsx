	...
	constructor(props) {
		...
		this.state = {
			...
			local_data:{
				...
				tipQQ: '3438538225',
				maxlength: 200,
				qqIcon: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/qqIcon.png',
				backBtn: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/backBtn.png',
				opinionTitleImg: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/opinionTitleImg.png',
				submitBtn: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/submitBtn.png',
			}
		};
