	...
	constructor(props) {
		...
		this.state = {
			...
			local_data:{
				...
				backpackTitle: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/backpackTitle.png',
				usedBtn: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/usedBtn.png',
				tipHaveCard: '拥有',
				tipCard: '局内道具',
				// 是否成功使用道具
				isUsedSuccess: false,
