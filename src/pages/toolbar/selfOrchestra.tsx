	...
	constructor(props) {
		...
		this.state = {
			...
			local_data:{
				...
				orchestraTitleImg: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/orchestraTitleImg.png',
				usingPrompt: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/usingBtn.png',
				replaceBtn: 'https://snm-qqapp.oss-cn-beijing.aliyuncs.com/v1.0.0/replaceBtn.png',
				leadSingerTitle: '主唱',
				guitaristTitle: '吉他手',
				bassistTitle: '贝斯手',
				drummerTitle: '鼓手',
