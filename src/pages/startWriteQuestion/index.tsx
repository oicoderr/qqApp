				...
				answers:[
					{
						...
						maxLength: 10,
						minLength: 1,
						icon: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/correctIcon.png',
					},{
						id: '2',
						placeholderText: '填写错误答案（1-10 字之间）',
						maxLength: 10,
						minLength: 1,
						icon: 'https://snm-qqapp-test.oss-cn-beijing.aliyuncs.com/qqApp-v1.0.0/mistakeIcon.png',
					},{
						id: '3',
						placeholderText: '填写错误答案（1-10 字之间）',
						maxLength: 10,
